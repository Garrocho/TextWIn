...
//                        Log.d("ENV", "SUCESSO");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        this.IP = sharedPref.getString("ip", "http://192.168.0.103:80");
    }
    ...
    public void obterNome() {
        ...
        SharedPreferences sharedPref2 = getSharedPreferences("TextWIn", Context.MODE_PRIVATE);

        String retrievedString2 = sharedPref2.getString("ip", "SemNome");

        if (retrievedString2.equalsIgnoreCase("SemNome")) {

            this.IP = "http://192.168.0.103:80";
            SharedPreferences.Editor editor = sharedPref.edit();
